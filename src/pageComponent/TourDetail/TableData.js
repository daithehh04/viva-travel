            ...
            return (
              ...
              >
                {values?.map((rowItem, rowIndex) => {
                  return (<td
                    className={`min-w-[5vw] whitespace-nowrap px-[1vw] lg:text-[1vw] md:text-[12px]  text-[2.93vw] leading-normal opacity-80 text-textColor border border-[#EBEBEB] border-solid text-center align-middle ${(index === data?.length - 1 && rowIndex === 0 && 'rounded-bl-2xl') || ''
