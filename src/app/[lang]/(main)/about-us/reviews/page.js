...
export default async function page({ params: { lang } }) {
  // const [res, dataCountry, dataYear] = await Promise.all([getAboutUsData(GET_REVIEWS_DATA, lang), getDataPost(lang, DATA_TAXONOMIES_COUNTRY), getDataYear(getYearReview)])
