    ...
    >
      {!loading ? (
        <div className='relative w-full h-full'>
          ...
          />
          {bestTour ? <span className='absolute top-[1vw] left-[1.5vw] tag-best_tour text-[0.75vw] w-max px-[1vw] py-[0.5vw] text-[#2b2b2b] bg-primaryColor block max-md:text-[2.667vw] max-md:px-2'>{tag}</span> : ""}
        </div>
      ) : (
        <Skeleton
          variant='rounded'
      ...
      <div className='absolute bottom-0 info md:pl-[1.5vw] md:pr-[0.94vw] px-[3.2vw] md:pb-[1.19vw] pb-[3.2vw] w-full'>
        ...
        {/* icons*/}
        <div className='flex md:gap-[0.25vw] gap-[1vw] mt-[1.33vw]'>
